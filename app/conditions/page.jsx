...
export default function AfectiuniPage() {
  ...
  return (
    <div className="space-y-10 text-slate-900">
      ...
      <SectionCard contentClassName="grid gap-4 lg:grid-cols-2">
        {items.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="flex gap-4 rounded-2xl border border-slate-200 bg-white/95 p-5 shadow-inner shadow-slate-200/70"
            >
