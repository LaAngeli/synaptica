    ...
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-white/90 via-white/85 to-slate-100/90 px-6 py-12 shadow-2xl shadow-slate-200 sm:px-10 lg:px-12">
      ...
      <div className="relative space-y-6">
        <div className="space-y-3">
          ...
          <h1 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">{t("legal.terms.title")}</h1>
          <p className="text-sm font-semibold text-slate-700">{t("legal.terms.updated")}</p>
          <p className="max-w-3xl text-slate-700">{t("legal.terms.intro")}</p>
        </div>
