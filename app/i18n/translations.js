...
export const translations = {
  en: {
    offerBanner: {
      ...
      priceOld: "3000 RON",
      priceNew: "2400 RON",
      validity: "Offer valid until July 31, 2026",
      callCta: "Call us",
          ...
          items: [
            {
              ...
              // Promoție oprită — preț normal. Decomentează `offer` pentru a reactiva reducerea
  ...
  ro: {
    offerBanner: {
      ...
      priceOld: "3000 RON",
      priceNew: "2400 RON",
      validity: "Ofertă valabilă până pe 31 iulie 2026",
      callCta: "Apelează-ne",
