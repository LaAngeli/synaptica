...
/**
 * Hero intro for the pricing page — title, short copy, and anchor cards.
 */
export default function PricingPageIntro({ t, groups }) {
  return (
      ...
      <div className="relative space-y-6">
        ...
        <div className="hidden space-y-3 pt-1 lg:block">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {groups.map((group) => {
              const Icon = PRICING_NAV_ICONS[group.key] || Radar;
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs leading-relaxed text-[#817e32] font-medium">
                        {group.navHighlight}
                      </p>
                    </div>
